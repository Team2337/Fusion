 ...
 *   - testPeriodic()
 */
public abstract class FusionRobotBase extends RobotBase {
  private enum Mode {
    kNone,
    kDisabled,
    kAutonomous,
  ...
  public void disabledPeriodic() {
    if (m_dpFirstRun) {
      System.out.println("Default disabledPeriodic() method... Make me do something!");
      m_dpFirstRun = false;
    }
  }
  ...
  public void autonomousPeriodic() {
    if (m_apFirstRun) {
      System.out.println("Default autonomousPeriodic() method... Make me do something!");
      m_apFirstRun = false;
    }
  }
  ...
  public void teleopPeriodic() {
    if (m_tpFirstRun) {
      System.out.println("Default teleopPeriodic() method... Make me do something!");
      m_tpFirstRun = false;
    }
  }
  ...
  public void allPeriodic() {
    if (m_apFirstRun) {
      System.out.println("Default allPeriodic() method... Make me do something!");
      m_apFirstRun = false;
    }
  }
  ...
  protected void loopFunc() {
    ...
    if (isDisabled()) {
      ...
      Fusion.getInstance().setMode("DISABLED");
      ...
      Fusion.getInstance().setMode("AUTON");
      ...
      Fusion.getInstance().setMode("TELEOP");
      ...
      Fusion.getInstance().setMode("TEST");
